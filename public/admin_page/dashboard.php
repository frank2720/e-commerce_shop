      ...
      <ul class="d-flex align-items-center">
        ...
        <li class="nav-item dropdown pe-3">
          ...
          <a class="nav-link nav-profile d-flex align-items-center pe-0" href="#" data-bs-toggle="dropdown">
            <img src="../imgs/profile.png" alt="Profile" class="rounded-circle">
    ...
    <div class="container">
        ...
        if (isset($_GET['insert_category'])) {
          ...
          <div class='input-group mb-3'>
            <span class='input-group-text'><img src='../imgs/favicon.jpg' height='30' /></span>
            <input type='text' class='form-control' placeholder='Add category..' name='cat_title' required>
